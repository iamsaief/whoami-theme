...
<div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"padding":{"bottom":"30px","top":"30px"}}},"layout":{"type":"flex","justifyContent":"space-between"}} -->
    <div class="wp-block-group" style="padding-top:30px;padding-bottom:30px"><!-- wp:group {"layout":{"type":"flex"}} -->
        ...
        <!-- wp:social-links {"openInNewTab":true,"iconColor":"wmi-body-text","iconColorValue":"hsl(0deg 0% 10.2%)","style":{"spacing":{"blockGap":{"left":"20px"}}},"className":"is-style-logos-only hide-on-desktop","layout":{"type":"flex","justifyContent":"center"}} -->
        <ul class="wp-block-social-links has-icon-color is-style-logos-only hide-on-desktop">
        ...
        <!-- wp:social-links {"openInNewTab":true,"iconColor":"wmi-body-text","iconColorValue":"hsl(0deg 0% 10.2%)","style":{"spacing":{"blockGap":{"left":"20px"}}},"className":"is-style-logos-only hide-on-mobile","layout":{"type":"flex","justifyContent":"center"}} -->
        <ul class="wp-block-social-links has-icon-color is-style-logos-only hide-on-mobile">
            <?php for ($i = 0; $i < count($social_icons_header); $i++) : ?>
                <!-- wp:social-link {"url":"<?php echo $social_icons_header[$i]['url']; ?>","service":"<?php echo $social_icons_header[$i]['slug']; ?>"} /-->
            <?php endfor; ?>
        </ul>
